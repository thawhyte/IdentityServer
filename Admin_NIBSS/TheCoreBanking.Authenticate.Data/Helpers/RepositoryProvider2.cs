...
{
    public class RepositoryProvider2 : IRepositoryProvider2
    {
        public RepositoryProvider2(RepositoryFactories2 repositoryFactories)
        {
        ...
        /// </summary>
        public TheCoreBankingAuthenticateContext DbContext { get; set; }

        /// <summary>
        /// Get or create-and-cache the default <see cref="IRepository_{T}"/> for an entity of type T.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// of the injected <see cref="RepositoryFactories2_"/>.
        /// </param>
        /// <remarks>
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<TheCoreBankingAuthenticateContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<TheCoreBankingAuthenticateContext, object> factory, TheCoreBankingAuthenticateContext dbContext)
        {
        ...
        /// <summary>
        /// The <see cref="RepositoryFactories2_"/> with which to create a new repository.
        /// </summary>
        /// <remarks>
        /// Should be initialized by constructor injection
        /// </remarks>
        private RepositoryFactories2 _repositoryFactories;
    }
}
