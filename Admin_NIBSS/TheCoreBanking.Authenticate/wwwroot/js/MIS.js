...
function misFormatter(value, row, index) {
    return [
        ...
        '<a style="color:white"  class="edit btn btn-sm btn-danger"  title="Edit MIS">'
            ...
            success: function (data) {
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        $('#misTable').
                            bootstrapTable(
                            'refresh', { url: 'CustomerSetup/listmis' });
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.toString != '' && result != null) {
                                swal({ title: 'Update MIS', text: 'MIS updated successfully!', type: 'success' }).then(function () { clear(); });
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.toString != '' && result != null) {
                                swal({ title: 'Add MIS', text: 'MIS added successfully!', type: 'success' }).then(function () { clear(); });
